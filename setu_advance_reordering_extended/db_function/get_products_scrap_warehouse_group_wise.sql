DROP FUNCTION IF EXISTS public.get_products_scrap_warehouse_group_wise(
    integer[],
    integer[],
    integer[],
    integer[],
...
CREATE OR REPLACE FUNCTION public.get_products_scrap_warehouse_group_wise(
