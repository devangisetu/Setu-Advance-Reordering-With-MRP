...
class AdvanceReorderProductwiseComponentDemandLine(models.Model):
    _name = 'advance.reorder.productwise.component.demand.line'
    _description = 'Product-Wise Component Demand Calculation Line'
    ...
    source_line_ids = fields.One2many(
        ...
        'productwise_component_demand_line_id',
    ...
    def action_view_source_products(self):
        """Open source products contributing to this component demand line."""
        self.ensure_one()
        return {
            ...
            'target': 'new',
            'domain': [
                ('productwise_component_demand_line_id', '=', self.id),
            ],
        }
