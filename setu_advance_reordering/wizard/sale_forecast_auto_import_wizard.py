...
class SaleForecasetAutoImportWizard(models.TransientModel):
    ...
    def get_data_auto_forecast_sale(self):
        ...
        if not product_ids:
            product_ids = product_product_obj.search([('categ_id', 'in', category_ids), ('is_storable', '=', True),('type','!=','combo')]).ids
    ...
    def export_file_data(self, forecast_sale_data, fiscal_period_ids):
        ...
        return {
            ...
            'url': '/web/content/?model=sale.forecast.auto.import.wizard&id=%s&field=export_file&filename=%s&download=true' % (
