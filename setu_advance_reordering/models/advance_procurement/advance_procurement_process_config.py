...
class AdvanceProcurementProcessConfig(models.Model):
    ...
    def onchange_warehouse_id(self):
        """
              ...
              use: get inter company, inter warehouse channel id and transit days on basis of warehouse.
        """
    ...
    def onchange_transit_days(self):
        """
            added by: Aastha Vora | On: Oct - 15 - 2024 | Task: 998
            use: get shipping arrival date on basis of transit days.
        """
    ...
    def onchange_shipment_arrival_date(self):
        """
             added by: Aastha Vora | On: Oct - 15 - 2024 | Task: 998
             use: used to get advance stock end date on basis of shipment arrival date.
        """
