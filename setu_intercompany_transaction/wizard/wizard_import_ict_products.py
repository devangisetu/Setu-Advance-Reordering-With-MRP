...
class ImportICTProduct(models.TransientModel):
    ...
    _description = """This wizard helps to choose file which will going to import ICT lines from csv files """
    ...
    def import_button(self):
        ...
        for line in archive_lines:
            ...
            line = intercompany_line_obj.search(
                [('product_id', '=', product_id.id), ('intercompany_transfer_id', '=', ict_id)])
            if line:
    ...
    def valid_prices(self, archive_lines):
        ...
        for line in archive_lines:
            ...
            try:
                ...
                raise UserError(
                    'The price of the product in the %s line, is not properly formatted.  Suitable formats, example: "$ 100.00" - "100.00" - "100"' % cont)
        return True
