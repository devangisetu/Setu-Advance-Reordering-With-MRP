...
class SetuICTAutoWorkflow(models.Model):
    ...
    _description = """This model is used to automate some activities in the intercompany transactions. 
        Like, Auto confirm sales order, purchase order, auto create customer invoice, vendor bill etc... """

    name = fields.Char(string="Name")
    validate_ict = fields.Boolean(string="Validate intercompany record?",
                                  help="""If this option is selected then it will create intercompany sale / purchase automatically""")
    ...
    ict_channel_ids = fields.One2many("setu.intercompany.channel", "auto_workflow_id", string="ICT Channels")
